        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-2xl">
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl sm:text-3xl">Payment Cancelled</CardTitle>
...
const PaymentCancelPage = async (props: PaymentCancelPageProps) => {
    return (
        <Suspense fallback={<PaymentCancelSkeleton />}>
            <PaymentCancelContent {...props} />
        </Suspense>
    );
};
